...
when 'ubuntu'
  ...
  default[:erlang][:root]       = "/usr/local/src/" + default[:erlang][:source_dir]
  default[:erlang][:bin]        = "/usr/local/bin"
  ...
  default[:elixir][:root]       = "/usr/local/src/elixir"
  ...
  default[:nodejs][:root]                 = "/usr/local/src/nodejs"
  default[:nodejs][:install_root]         = "/usr/local/src/"
